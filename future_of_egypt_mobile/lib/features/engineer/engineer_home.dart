...
class _EngineerHomeState extends State<EngineerHome> with WidgetsBindingObserver {
  ...
  Future<void> _startBackgroundTasksIfReady() async {
    ...
    if (shouldTrack && !isRunning) {
      ...
      try {
        ...
        await DeviceHealthService.reportRecoveryEvent(
          ...
          engineerPublicId: engineerId,
          devicePublicId: widget.deviceId,
          recoveryReason: 'RecoveredAfterAppOpen',
          lastError: 'BackgroundServiceStopped',
        );
      } catch (e) {
    ...
    if (permission == LocationPermission.always) {
      ...
      debugPrint('[FOE_BACKGROUND] Cannot start location tracking: Permission is not Always ($permission). Sending health-only report.');
      try {
        final config = await TrackingConfigService.getTrackingData();
        final engineerId = config['engineerPublicId'] as String? ?? widget.engineerId;
        await DeviceHealthService.reportHealth(
          ...
          devicePublicId: widget.deviceId,
          backgroundServiceAlive: false,
          lastError: 'Location permission is not Always ($permission).',
          trackingIntervalMs: TrackingIntervals.locationUpdateInterval.inMilliseconds,
        ).timeout(const Duration(seconds: 15));
      } catch (e) {
        debugPrint('[FOE_BACKGROUND] Failed to send health-only report: $e');
      }
    }
  }
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        _profileData?['fullName'] ?? 'Engineer Name',
                            ...
                            Row(
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: isOnline ? Colors.greenAccent.shade400 : Colors.redAccent.shade100,
                                      ),
                                    ),
                                  ],
                                ),
                                ...
                                Row(
                                  children: [
                                    Icon(
                                      ...
                                      color: _isAuthorized ? Colors.blueAccent.shade100 : Colors.redAccent.shade100,
                                      size: 16,
                                    ),
                                    const SizedBox(width: 6),
                                    Text(
                                      _isAuthorized ? "Authorized" : "Unauthorized",
                                      style: TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600,
                                        color: _isAuthorized ? Colors.blueAccent.shade100 : Colors.redAccent.shade100,
                                ...
                                // Elegant Chat Button inside profile card
                                GestureDetector(
                                  onTap: _isAuthorized
                                      ? () {
                                          Navigator.push(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: _isAuthorized ? Colors.white.withOpacity(0.15) : Colors.white12,
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(
                                          ...
                                          color: _isAuthorized ? Colors.white : Colors.white38,
                                          size: 16,
                                        ),
                                        const SizedBox(width: 6),
                                        Text(
                            ...
                            if (missingReqs.isEmpty)
                              Row(
                                children: [
                                  ...
                                  const Expanded(
                                    child: Text(
                                      "All required permissions are enabled. Active tracking is running.",
